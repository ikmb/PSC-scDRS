...
#  <repo>//PSC-scDRS/output/files_for_MAGMA.txt"
#  <repo>//PSC-scDRS/output/files_for_step2.txt"
#  <repo>//PSC-scDRS/output/files_step1.genes.annot"
# output:
#  <repo>//PSC-scDRS/output/files_step1"
#  <repo>//PSC-scDRS/output/files_step2"
#==============================================================================================================
