...
“Gene coordinates in the single-variant sample file are based on the GRCh38 (build 38) human genome assembly, and the reference dataset corresponds to a European population.”
